...
/***/ "./node_modules/ngx-international-phone-number/index.js":
/*!**************************************************************!*\
  !*** ./node_modules/ngx-international-phone-number/index.js ***!
  \**************************************************************/
/*! exports provided: InternationalPhoneNumberModule, CountryService, CountryPipe, PhoneNumberComponent, OnlyNumberDirective */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "InternationalPhoneNumberModule", function() { return InternationalPhoneNumberModule; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CountryService", function() { return CountryService; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CountryPipe", function() { return CountryPipe; });
...
/* harmony import */ var google_libphonenumber__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! google-libphonenumber */ "./node_modules/google-libphonenumber/dist/libphonenumber.js");
...
var COUNTER_CONTROL_ACCESSOR = {
    ...
    useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["forwardRef"])(function () { return PhoneNumberComponent; }),
    multi: true
};
/** @type {?} */
var VALIDATOR = {
...
var PhoneNumberComponent = /** @class */ (function () {
    function PhoneNumberComponent(countryService, phoneComponent) {
        ...
        this.type = 'text';
        this.onCountryCodeChanged = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
    ...
    function (c) {
        ...
        if (value) {
            ...
            /** @type {?} */
            var phoneUtil = google_libphonenumber__WEBPACK_IMPORTED_MODULE_3__["PhoneNumberUtil"].getInstance();
            try {
                /** @type {?} */
    ...
    PhoneNumberComponent.propDecorators = {
        ...
        defaultCountry: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] }],
        required: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] }],
        allowDropdown: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] }],
        type: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] }],
        allowedCountries: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] }],
        onCountryCodeChanged: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"] }],
        phoneNumberInput: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"], args: ['phoneNumberInput',] }],
        handleKeyboardEvent: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["HostListener"], args: ['document:keypress', ['$event'],] }]
    };
...
var OnlyNumberDirective = /** @class */ (function () {
    ...
    OnlyNumberDirective.propDecorators = {
        onlyNumber: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"] }],
...
module.exports = "<ion-header>\n  <ion-header>\n    <ion-toolbar  color=\"primary\">\n      <ion-title style=\"margin-left: 10%\">\n       Bienvenue sur  Mon ecolier\n      </ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content fullscreen>\n    \n    <ion-grid no-padding>\n        <ion-row>\n          <ion-col fullscreen no-padding> <ion-img  class=\"image\" src=\"assets/imgs/p1.jpg\" ></ion-img></ion-col>\n        </ion-row>\n    </ion-grid>\n   \n    <hr/>\n    <form [formGroup]=\"registerForm\" (ngSubmit)=\"saveParent()\">\n    <ion-grid>\n        <ion-row>\n          <ion-col>\n      <ion-item>\n        <ion-label position=\"floating\">Nom</ion-label>\n        <ion-input type=text  name=\"nom\" formControlName=\"nom\"></ion-input>\n      </ion-item>\n    </ion-col>\n      </ion-row>\n      <ion-row>\n        <ion-col>\n    <ion-item>\n      <ion-label position=\"floating\">Prenoms</ion-label>\n      <ion-input type=text  name=\"prenoms\" formControlName=\"prenoms\"></ion-input>\n    </ion-item>\n  </ion-col>\n    </ion-row>\n          <ion-row>\n            <ion-col>\n          <ion-item>\n              <ion-label position=\"floating\">Telephone(22891754012)</ion-label>\n              <ion-input type=\"number\" name=\"telephone\" formControlName=\"telephone\"></ion-input>\n          </ion-item>\n          </ion-col>\n          </ion-row>\n       <br/>\n      <ion-row>\n          <ion-col align-self-center>\n            \n        <ion-button color=\"primary\" style=\"margin-left: 15%\" type=\"submit\" [disabled]=\"!registerForm.valid\" ><ion-icon name=\"checkmark-circle-outline\"></ion-icon>&nbsp;Inscription</ion-button>\n        </ion-col>\n        <ion-col align-self-center>\n        <ion-button color=\"medium\"  style=\"margin-left: 10%\"  (click)=\"exitApp()\"> <ion-icon name=\"close-circle-outline\"></ion-icon>&nbsp;Annuler</ion-button>\n      </ion-col>\n      </ion-row>\n</ion-grid>\n</form>\n</ion-content>\n\n"
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _eleve_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../eleve.service */ "./src/app/eleve.service.ts");
...
var RegisterPage = /** @class */ (function () {
    function RegisterPage(menuCtrl, platform, alertCtrl, router, eleveService) {
        ...
        this.registerForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormGroup"]({
            ...
            prenoms: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required),
            telephone: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required),
        });
    ...
    RegisterPage.prototype.saveParent = function () {
        var _this = this;
        console.log(this.registerForm.value);
        this.parent = this.registerForm.value;
        this.eleveService.registeruser(this.parent).subscribe(function (data) {
            if (data.code == 800) {
                var user = data.datas;
                _this.eleveService.iduser = user.id;
                _this.eleveService.username = user.username;
                _this.eleveService.password = user.password;
                _this.router.navigate(['confirm']);
            }
        });
    };
    RegisterPage.prototype.exitApp = function () {
    ...
    RegisterPage.ctorParameters = function () { return [
        ...
        { type: _eleve_service__WEBPACK_IMPORTED_MODULE_1__["EleveService"] }
    ]; };
    RegisterPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["MenuController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["Platform"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["AlertController"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"], _eleve_service__WEBPACK_IMPORTED_MODULE_1__["EleveService"]])
    ], RegisterPage);
    return RegisterPage;
}());
