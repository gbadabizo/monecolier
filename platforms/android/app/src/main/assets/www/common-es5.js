...
/***/ "./src/app/eleve.service.ts":
/*!**********************************!*\
  !*** ./src/app/eleve.service.ts ***!
  \**********************************/
/*! exports provided: EleveService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EleveService", function() { return EleveService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
var api = 'http://192.168.0.102:8080/auth/';
var EleveService = /** @class */ (function () {
    ...
    EleveService.prototype.registeruser = function (parent) {
        var apiurl = api + 'register';
        return this.http.post(apiurl, parent);
    };
    EleveService.prototype.confirm = function (iduser, code) {
        var apiurl = api + 'confirm/' + iduser + '/' + code;
        console.log(apiurl);
        return this.http.get(apiurl);
    };
    EleveService.prototype.getEcole = function () {
        var apiurl = api + 'ecoles';
        return this.http.get(apiurl);
    };
    EleveService.prototype.getAnnees = function () {
        var apiurl = api + 'annees';
        return this.http.get(apiurl);
    };
    EleveService.prototype.saveParent = function (parameters) {
        var apiurl = api + 'addParent';
        return this.http.post(apiurl, parameters);
    };
    EleveService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
    EleveService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
