...
let ElevePageModule = class ElevePageModule {
};
...
let ElevePage = class ElevePage {
    constructor(alertCtrl, router, eleveService, storage) {
    ...
    ngOnInit() {
        this.eleveService.getEcole().subscribe((data) => {
            console.log(data);
            if (data.code == 800) {
                this.ecoles = data.datas;
            }
        });
        this.eleveService.getAnnees().subscribe((data) => {
            if (data.code == 800) {
    ...
    saveAddEleve() {
        ...
        this.eleveService.saveParent(this.parameters).subscribe((data) => {
            console.log(data);
            if (data.code == 800) {
                this.isadd = false;
...
//# sourceMappingURL=eleve-eleve-module-es2015.js.map